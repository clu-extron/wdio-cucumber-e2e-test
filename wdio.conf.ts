...
// DEBUG: console.log(`>> The debug flag: ${debug}`);
...
export const config: Options.Testrunner = {
  ...
  afterStep: async function (step, scenario, result, context) {
    // DEBUG: console.log(`>> step: ${JSON.stringify(step)}`);
    // DEBUG: console.log(`>> scenario: ${JSON.stringify(scenario)}`);
    // DEBUG: console.log(`>> result: ${JSON.stringify(result)}`);
    // DEBUG: console.log(`>> context: ${JSON.stringify(context)}`);
